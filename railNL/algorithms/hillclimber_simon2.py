...
class HillClimber():
    ...
    def checkSolution(self, newRoutes: List[List[str]]) -> None:
        ...
        if newScore >= oldScore:
            ...
            self.workModel.exportSolution("snake2ClimberMinGroningen11", "snake2Climber1")
        else:
    ...
    def run(self, iterations: int = 30000, verbose=False, mutate_nodes_number=1) -> None:
        ...
        # exports scores
        exportScores(self.scores, "snake2ClimberMinGroningen11", "snake2Climber1", START_TIMESTAMP)
