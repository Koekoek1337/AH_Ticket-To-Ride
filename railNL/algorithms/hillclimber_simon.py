...
class HillClimber():
    ...
    def __init__(self):
        ...
        model = randomSolution(RailNetwork("data/StationNationaal.csv", "data/ConnectiesNationaal.csv"), 20, 180, 50000)
        self.routes = model.listRoutes()
        self.score = self.routes.score()
    ...
    def mutateLastStation(self) -> List[str]:
        """
        ...
        # or add new station as first station
            ...
            newRoute.appendStation(0, random.choice(newRoute.listStations()))
    ...
    def mutateFirstStation(self) -> List[str]:
        """
    ...
    def run(self, iterations: int = 50000, verbose=False, mutate_nodes_number=1) -> None:
        ...
        for iteration in range(iterations):
            ...
            self.mutateRoute(self)

            # Accept it if it is better
            self.checkSolution(newRoutes)
